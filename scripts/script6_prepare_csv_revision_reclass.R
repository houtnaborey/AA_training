...
setwd("D:/Training/AA_Change_15-19_May_2017/Data/khm_ws_20170515/results")

## Read the datafile and setup the correct names for the variables
pts_results <- read.csv("D:/Training/AA_Change_15-19_May_2017/Data/khm_ws_20170515/results/remilinux_collectedData_earthaa_cambodia_CE_2017-05-18_on_180517_115425_CSV.csv")
...
out <- pts_origin[
  pts_origin$id %in% pts_results[
    ...
    |
    (pts_results$ref_class == 1 & pts_results$map_class == 2)
    |
    (pts_results$ref_class == 2 & pts_results$map_class == 4)
    ,
    ]$id,
  ]
