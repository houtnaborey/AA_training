...
lsat_dir <- paste0(rootdir,"time_series/")

#### Name of the directory where your Sentinel data is
stnl_dir <- paste0(rootdir,"time_series/")
...
pts <- read.csv("pts_cambodia_CE_2017-05-16.csv")  #####  CHANGE TO MY VALUE HERE
